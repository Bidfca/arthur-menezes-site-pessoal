...
function About() {
  return (
    <article className="alingItens">
      ...
      <div>
        <h1 className='tituloAbout'>Olá, eu sou Arthur Menezes</h1>
      </div>
      <div>
        <section>
        ...
        <section className="alingatinsLine">
          ...
          />
          <p className='desptionImage'>Depois de alguns anos, sem entender o que era aquele cilindro preto em uma tabua verde, entrei para área de tecnologia, comecei estudando programação web básica, HTML, CSS, JS, elaborando sites bem feios, mas que funcionavam e cumpriam seu proposito, apos algum tempo, resolvi me aprofundar e me tornar um desenvolvedor Full Stack, honestamente, devo dizer que não sei se gosto mais de Front ou de Back end, as duas áreas são incríveis, e atuarei na área por mais alguns anos.</p>
        </section>
        <section className="alingatinsLine">
          <img
        ...
        <section className="alingatinsLine">
          ...
          />
          <p className='desptionImage'>Adoro píxel art, apesar de ser um artista iniciante, ainda sim, acho incrível como um simples quadradinho pode mudar tudo. Se ele ficar em uma cor diferente, é uma sombra, ou uma estrela, ou ate mesmo um pássaro, tudo depende de como e onde foi colocado.</p>
        </section>
      </div>
    </article>
  );
